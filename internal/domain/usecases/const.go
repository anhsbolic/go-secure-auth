...
const (
	...
	errFindUser                 = "failed to find user"
	...
	errRevokeUserSession        = "failed to revoke user session"
	errRevokeUserSessions       = "failed to revoke all user sessions"
	...
	invalidLogoutData           = "invalid logout data"
	invalidOldPassword          = "invalid old password"
	invalidNewPassword          = "invalid new password"
	invalidOTP                  = "invalid otp"
	invalidPassword             = "invalid password"
	invalidRefreshTokenData     = "invalid refresh token data"
	...
	userLoggedOutAll            = "user logged out all"
